...
#define _MX6Q_PAD_GPIO_5__GPIO_1_5			\
		IOMUX_PAD(0x060C, 0x023C, 5, 0x0000, 0, 0x5800) //0->0x5800
...
#define _MX6Q_PAD_GPIO_16__GPIO_7_11			\
		IOMUX_PAD(0x0618, 0x0248, 5, 0x0000, 0, 0)//0->0x5800
...
#define  MX6Q_PAD_GPIO_5__GPIO_1_5		\
		(_MX6Q_PAD_GPIO_5__GPIO_1_5 | MUX_PAD_CTRL(MX6Q_CCM_CLK0_PAD_CTRL))
...
#define  MX6Q_PAD_GPIO_16__GPIO_7_11		\
		(_MX6Q_PAD_GPIO_16__GPIO_7_11 | MUX_PAD_CTRL(MX6Q_CCM_CLK0_PAD_CTRL))
