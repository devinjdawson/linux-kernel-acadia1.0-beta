...
#define SABRESD_ECSPI0_CS0      IMX_GPIO_NR(4, 24)
...
#define SABRESD_SATA_POWER      IMX_GPIO_NR(4, 15)

#define FT5X_TOUCH

#ifdef FT5X_TOUCH
#define SABRESD_FT5X_INT        IMX_GPIO_NR(5, 5)
#define ARDUINO_D2              IMX_GPIO_NR(4,27)
#define ARDUINO_D3              IMX_GPIO_NR(4,29)
#define ARDUINO_D4              IMX_GPIO_NR(4,28)
#endif
...
///////////////////////////////spi0/////////////////////////////////////////////
#if 1
static int mx6q_sabresd_spi0_cs[] = {
        SABRESD_ECSPI0_CS0,
};

static const struct spi_imx_master mx6q_sabresd_spi0_data __initconst = {
        .chipselect     = mx6q_sabresd_spi0_cs,
        .num_chipselect = ARRAY_SIZE(mx6q_sabresd_spi0_cs),
};

static struct spi_board_info imx6_sabresd_spi0_spidev_device[] __initdata = {
        {
                .modalias = "spidev",
                .max_speed_hz = 20000000, /* max spi clock (SCK) speed in HZ */
                .bus_num = 0,
...
///////////////////////////////spi1/////////////////////////////////////////////
#if 1
static int mx6q_sabresd_spi1_cs[] = {
        SABRESD_ECSPI1_CS0,
};

static const struct spi_imx_master mx6q_sabresd_spi1_data __initconst = {
        .chipselect     = mx6q_sabresd_spi1_cs,
        .num_chipselect = ARRAY_SIZE(mx6q_sabresd_spi1_cs),
};

static struct spi_board_info imx6_sabresd_spi1_spidev_device[] __initdata = {
        {
                .modalias = "spidev",
                .max_speed_hz = 20000000, /* max spi clock (SCK) speed in HZ */
                .bus_num = 2, 
...
{
#if 0
	spi_register_board_info(imx6_sabresd_spi_nor_device,ARRAY_SIZE(imx6_sabresd_spi_nor_device));
#endif

#if 1
	spi_register_board_info(imx6_sabresd_spi0_spidev_device,ARRAY_SIZE(imx6_sabresd_spi0_spidev_device));
#endif 
#if 1
	spi_register_board_info(imx6_sabresd_spi1_spidev_device,ARRAY_SIZE(imx6_sabresd_spi1_spidev_device));
#endif
}
...
static struct i2c_board_info mxc_i2c2_board_info[] __initdata = {
	{
		I2C_BOARD_INFO("ft5x_ts",0x38),
		.irq = gpio_to_irq(SABRESD_FT5X_INT),
	}
	/*{
...
static struct platform_pwm_backlight_data mx6_sabresd_pwm0_data = {
        .pwm_id = 0, 
        .max_brightness = 248,
        .dft_brightness = 130,
        .pwm_period_ns = 50000,
...
static struct platform_pwm_backlight_data mx6_sabresd_pwm1_data = {
        .pwm_id = 1, 
        .max_brightness = 248,
        .dft_brightness = 140,
        .pwm_period_ns = 50000,
...
static struct platform_pwm_backlight_data mx6_sabresd_pwm2_data = {
        .pwm_id = 2, 
        .max_brightness = 248,
        .dft_brightness = 150,
        .pwm_period_ns = 50000,
...
static struct platform_pwm_backlight_data mx6_sabresd_pwm3_data = {
        .pwm_id = 3, 
        .max_brightness = 248,
        .dft_brightness = 160,
        .pwm_period_ns = 50000,
...
static void __init mx6_sabresd_board_init(void)
{
	...
	//sata power on
	gpio_request(SABRESD_SATA_POWER, "gpio");
        gpio_direction_output(SABRESD_SATA_POWER, 1);

	gpio_request(ARDUINO_D2,"gpio");
	gpio_direction_output(ARDUINO_D2,1);
	
        gpio_request(ARDUINO_D3,"gpio");
        gpio_direction_output(ARDUINO_D3,0);

        gpio_request(ARDUINO_D4,"gpio");
        gpio_direction_output(ARDUINO_D4,1);
...
//	imx6q_add_ecspi(0, &mx6q_sabresd_spi_data);
	imx6q_add_ecspi(0, &mx6q_sabresd_spi0_data);
#endif	

#if 1
	imx6q_add_ecspi(2, &mx6q_sabresd_spi1_data);
#endif
	spi_device_init();
	...
	*/
	...
	imx6q_add_mxc_pwm_expwm(0, &mx6_sabresd_pwm0_data);
	imx6q_add_mxc_pwm_expwm(1, &mx6_sabresd_pwm1_data);
	imx6q_add_mxc_pwm_expwm(2, &mx6_sabresd_pwm2_data);
	imx6q_add_mxc_pwm_expwm(3, &mx6_sabresd_pwm3_data);
